...
clear all; close all; clc
     mainpath = 'C:\Users\gavin\Documents\MATLAB\ProjectData\Bursts\AK47\1k spectrograms';
...
%          imshow(blurspectro)
         ...
         mainpath = 'C:\Users\gavin\Documents\MATLAB\ProjectData\Bursts\M4\1k spectrograms';
        D=dir(fullfile(mainpath,'*cropped.jpg'));  
Band4Samp=[];
Band4AveSamp=[];
...
eng10perc=sum(sig(1:16))/sum(sig)
eng25perc=sum(sig(1:41))/sum(sig)
eng50perc=sum(sig(1:81))/sum(sig)
eng=sum(sig(1:150))/sum(sig)
...
for j=1:3
    k=k+1;
  subplot(3,3,k) 
  plot(1:54,V(1:54,j),'ko-') 
  k=k+1;
  subplot(3,3,k) 
  plot(55:108,V(55:108,j),'ko-')
  k=k+1;
  subplot(3,3,k) 
  plot(109:162,V(109:162,j),'ko-')
end
...
figure(5)
plot3(V(1:54,1),V(1:54,2),V(1:54,3),'ko','Linewidth',[2]) 
hold on
plot3(V(55:108,1),V(55:108,2),V(55:108,3),'ro','Linewidth',[2])
hold on
plot3(V(109:162,1),V(109:162,2),V(109:162,3),'go','Linewidth',[2])
% hold on
...
q1 = randperm(54); q2 = randperm(54); q3 = randperm(54); q4 = randperm(54);

xband1 = V(1:54,1:15); xband2 = V(55:108,1:15);
xband3 = V(109:162,1:15); 
% xband4 = V(85:112,1:10);

xtrain = [xband1(q1(1:47),:); xband2(q2(1:47),:); xband3(q3(1:47),:)];
% xtrain2 = [xband1(q1(1:21),:); xband3(q2(1:21),:); xband4(q4(1:21),:)];
xtest = [xband1(q1(48:end),:); xband2(q2(48:end),:); xband3(q3(48:end),:)];
% xtest2 = [xband1(q1(22:end),:); xband3(q3(22:end),:); xband4(q4(22:end),:)];
ctrain = [ones(47,1); 2*ones(47,1); 3*ones(47,1)];
...
title('AK-47 Samples'), text(2,6800,'Accuracy='+string(round(success1tree*100,1))+'%','Fontsize',[12])
subplot(1,3,2)
histogram(band2pretree,3,'BinWidth',.8), axis([1 3 0 7000])
xticks([1.2 2 2.7]),xticklabels({'AK47', 'FAL', 'M4'})
set(gca,'YTick',[1000 2000 3000 4000 5000 6000 7000], 'Fontsize',[12]), 
title('FAL Samples'), text(2,6800,'Accuracy='+string(round(success2tree*100,1))+'%','Fontsize',[12])
subplot(1,3,3)
histogram(band3pretree,3,'BinWidth',.8), axis([1 3 0 7000])
xticks([1.2 2 2.7]),xticklabels({'AK47', 'FAL', 'M4'})
set(gca,'YTick',[1000 2000 3000 4000 5000 6000 7000], 'Fontsize',[12]),
title('M4 Samples'), text(2,6800,'Accuracy='+string(round(success3tree*100,1))+'%','Fontsize',[12])
% subplot(1,4,4)
