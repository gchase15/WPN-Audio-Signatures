...
title('AK-47 Samples'), text(2,6800,'Accuracy='+string(round(success1lda*100,1))+'%','Fontsize',[12])
subplot(1,3,2)
histogram(band2prelda,3,'BinWidth',.8), axis([1 3 0 7000])
xticks([1.2 2 2.7]),xticklabels({'AK47', 'FAL', 'M4'})
set(gca,'YTick',[1000 2000 3000 4000 5000 6000 7000], 'Fontsize',[12]), 
title('FAL Samples'), text(2,6800,'Accuracy='+string(round(success2lda*100,1))+'%','Fontsize',[12])
subplot(1,3,3)
histogram(band3prelda,3,'BinWidth',.8), axis([1 3 0 7000])
xticks([1.2 2 2.7]),xticklabels({'AK47', 'FAL', 'M4'})
set(gca,'YTick',[1000 2000 3000 4000 5000 6000 7000], 'Fontsize',[12]),
title('M4 Samples'), text(2,6800,'Accuracy='+string(round(success3lda*100,1))+'%','Fontsize',[12])
% subplot(1,4,4)
